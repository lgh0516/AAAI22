...
#kidtx = pd.read_csv('GBMLGG_Surv_data_methylation_mRNA_all_lmqcm.csv')
...
kidtx = pd.read_csv('GBMLGG_Surv_data_methylation_mRNA_important_raw_500.csv')
...
#    plt.show() 
    ...
    plt.title('Weight Curves on GBMLGG ')
    plt.ylabel('Training-weight Value')
    plt.xlabel('epoch')
    plt.legend(['lambda1','lambda2','lambda3','lambda4'], loc='upper right')
    plt.savefig('GBMLGG With Penalty TermMT_ADSCCA lambda1-lambda4 Curves term315.jpg', dpi=300) #指定分辨率保存
    plt.show()
    
    plt.plot(range(EPOCH), hist.history['loss'])
    plt.title('Training Loss Curves Using MT_ADSCCA on GBMLGG')
    plt.ylabel('training-loss Value')
    plt.xlabel('epoch')
#    plt.legend(['${lambda0}$','${lambda1}$'], loc='upper right')
    plt.savefig('GBMLGG Loss Curves with penalty term315.jpg', dpi=300) #指定分辨率保存
    plt.show()
    
    
    np.savetxt("ALL_with_GBMLGG_methylation_mRNA_MT_DSCCA_20210902.csv",hist.history['loss'], delimiter=",")
    aaa=0
#    import pylab
...
np.savetxt("GBMLGG_data_mm_dscca_p001_8-9_414.csv",data_mm2, delimiter=",")

#pd.dataFrame.to_save()
data_y_mm_name55.to_csv("GBMLGG_data_mm_name_dscca_p001_8-9_414.csv")
...
#np.savetxt("GBMLGG_prediction20210125_18lstm2222_epoch400_drop01_resnet_without penalty term315.csv", ypred, delimiter=",")
#np.savetxt("GBMLGG_ytime_test20210125_18lstm2222_epoch400_drop01_resnet_without penalty term315.csv", time_new, delimiter=",")
#np.savetxt("GBMLGG_ystatus_test20210125_18lstm2222_epoch400_drop01_resnet_without penalty term315.csv", status_new, delimiter=",")
#np.savetxt("GBMLGG_ypred_train_median20210125_18lstm2222_epoch400_drop01_resnet_without penalty term315.csv", ypred_train, delimiter=",")
#
#df = pd.read_csv("GBMLGG_prediction20210125_18lstm2222_epoch400_drop01_resnet_without penalty term315.csv",header=None)    
#month=np.asarray(pd.read_csv("GBMLGG_ytime_test20210125_18lstm2222_epoch400_drop01_resnet_without penalty term315.csv",header=None)) 
#status=np.asarray(pd.read_csv("GBMLGG_ystatus_test20210125_18lstm2222_epoch400_drop01_resnet_without penalty term315.csv",header=None)) 
#
#
##df=ypred
##month=time_new
...
#print("GBMLGG_methylation17_mRNA36_lmqcm_lr_backend2233_without_penalty_term3_NO_PPPPplot_new_dataset_20210118_3333_all_0.7222063242237802_no_tf.clip_by_value22.py") 
#print("GBMLGG:dataX=data_all:",c_indices_lstm)
