...
#    plt.show() 
    ...
    plt.savefig('KIPAN With Penalty TermMT_ADSCCA lambda1-lambda4 Curves term315.jpg', dpi=300) #指定分辨率保存
    plt.show()
...
#    plt.legend(['${lambda0}$','${lambda1}$'], loc='upper right')
    plt.savefig('KIPAN Loss Curves with penalty term315.jpg', dpi=300) #指定分辨率保存
    plt.show()
    
    
    np.savetxt("with_KIPAN_methylation_mRNA_MT_DSCCA_20210902.csv",hist.history['loss'], delimiter=",")
    aaa=0
#    import pylab
